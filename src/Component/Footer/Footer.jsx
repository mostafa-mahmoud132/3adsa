...
export default function Footer() {
  ...
  const handleLinkClick = (path, scrollTop = 0) => {
    navigate(path);
    ...
    <footer className="relative bg-[#0a0a0a] text-neutral-300 overflow-hidden border-t border-[#262626]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          <div>
            <a href="/" className="flex items-center gap-3 mb-6 group">
              <div
                ...
                style={{ boxShadow: "0 4px 20px rgba(249,115,22,.3)" }}
              >
            ...
            <ul className="space-y-4">
              <li>
                <button
                  ...
                  className="text-sm text-neutral-500 hover:text-orange-500 transition flex items-center gap-2 group"
                >
              ...
              <li>
                <button
                  onClick={() => handleLinkClick("/blog", 0)}
                  className="text-sm text-neutral-500 hover:text-orange-500 transition flex items-center gap-2 group"
                >
                  <span className="opacity-0 -mr-4 group-hover:opacity-100 group-hover:mr-0 transition-all duration-300 text-orange-500 rotate-180">
                    ➜
              ...
              <li>
                <button
                  onClick={() => handleLinkClick("/about", 0)}
                  className="text-sm text-neutral-500 hover:text-orange-500 transition flex items-center gap-2 group"
                >
                  <span className="opacity-0 -mr-4 group-hover:opacity-100 group-hover:mr-0 transition-all duration-300 text-orange-500 rotate-180">
                    ➜
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <button
                  onClick={() => handleLinkClick("/blog?category=إضاءة", 400)}
                  className="text-sm text-neutral-500 hover:text-orange-500 transition flex items-center gap-2 group"
                >
                  <span className="opacity-0 -mr-4 group-hover:opacity-100 group-hover:mr-0 transition-all duration-300 text-orange-500 rotate-180">
                    ➜
              ...
              <li>
                <button
                  onClick={() => handleLinkClick("/blog?category=بورتريه", 400)}
                  className="text-sm text-neutral-500 hover:text-orange-500 transition flex items-center gap-2 group"
                >
                  <span className="opacity-0 -mr-4 group-hover:opacity-100 group-hover:mr-0 transition-all duration-300 text-orange-500 rotate-180">
                    ➜
              ...
              <li>
                <button
                  onClick={() =>
                    handleLinkClick("/blog?category=مناظر طبيعية", 400)
                  }
                  className="text-sm text-neutral-500 hover:text-orange-500 transition flex items-center gap-2 group"
                >
                  <span className="opacity-0 -mr-4 group-hover:opacity-100 group-hover:mr-0 transition-all duration-300 text-orange-500 rotate-180">
              ...
              <li>
                <button
                  onClick={() => handleLinkClick("/blog?category=تقنيات", 400)}
                  className="text-sm text-neutral-500 hover:text-orange-500 transition flex items-center gap-2 group"
                >
                  <span className="opacity-0 -mr-4 group-hover:opacity-100 group-hover:mr-0 transition-all duration-300 text-orange-500 rotate-180">
                    ➜
          ...
          <div>
            ...
            <form className="space-y-3">
              <input
                ...
                className="w-full px-4 py-3 bg-[#161616] border border-[#262626] rounded-xl text-sm text-white focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500"
              />
      ...
      <div className="border-t border-[#262626]">
        <div className="max-w-7xl mx-auto px-4 py-6 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-neutral-600">© 2026 عدسة. صنع بكل ❤️</p>
