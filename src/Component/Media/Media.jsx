    ...
    <>
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <span
            className="section-label inline-flex px-3 py-1.5 items-center border  text-center border-[#d23a10ca] rounded-full gap-2 mb-[40px] text-orange-500 text-sm"
            style={{ backgroundColor: "rgba(249, 130, 22, 0.2)" }}
          >
